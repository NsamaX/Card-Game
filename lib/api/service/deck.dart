...
class DeckService {
  Future<bool> check({required String game, required String cardName}) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    List<String>? savedCards = prefs.getStringList('user_deck');
    if (savedCards != null) {
      String lowerCaseCardName =
          cardName.toLowerCase().toLowerCase().replaceAll(' ', '');
